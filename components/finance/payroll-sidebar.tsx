...
export function PayrollSidebar({ agent }: PayrollSidebarProps) {
  ...
  return (
    <div className="payroll-cutout w-full text-dash-dark h-fit overflow-y-auto border-dash-dark/5 bg-white p-8 sm:p-[55px_42px_46.52px] relative rounded-2xl shadow-[0px_1px_3px_0px_#0000004D,0px_4px_8px_3px_#00000026]">
