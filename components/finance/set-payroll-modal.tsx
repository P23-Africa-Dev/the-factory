...
function Toggle({
  ...
  return (
    <button
      type="button"
      onClick={onToggle}
      className={`relative inline-flex h-[26px] w-[48px] items-center rounded-full transition-colors cursor-pointer ${
...
function CommissionModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-[24px] w-full max-w-[420px] mx-4 p-7 shadow-2xl">
        <h3 className="text-[16px] font-bold text-[#0B1215] mb-5">Commission</h3>

        {/* Preference Selection */}
        <div className="mb-5">
          <p className="text-[12px] font-semibold text-gray-500 mb-3">Choose Preference</p>
        ...
        <div className="mb-5">
          <div className="flex items-center justify-between mb-3">
            <p className="text-[12px] font-semibold text-gray-500">Add Product</p>
            <button
              type="button"
              onClick={addProduct}
...
export function SetPayrollModal({ isOpen, onClose }: SetPayrollModalProps) {
  ...
  const [commissionPreference, setCommissionPreference] = useState<CommissionPreference>('per-unit');
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        {/* Modal */}
        <div className="relative bg-white rounded-[28px] w-full max-w-[400px] mx-4 shadow-2xl overflow-hidden">
          {/* Header with dark wave */}
          <div className="bg-[#0B1215] h-[72px] relative overflow-hidden flex items-center px-7">
            ...
            <h2 className="text-[18px] font-bold text-white relative z-10">Set Payroll</h2>
            <button
              onClick={onClose}
          ...
          <div className="px-7 py-6 max-h-[calc(100vh-200px)] overflow-y-auto">
            {/* Salary Section */}
            <div className="mb-6">
              <p className="text-[13px] font-bold text-[#0B1215] mb-4">Salary</p>

              <div className="space-y-3">
                {/* Salary Type */}
                <div className="flex items-center justify-between">
                  <label className="text-[11px] text-gray-400 font-medium">Salary Type</label>
                  <div className="relative">
                    ...
                    <svg className="absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#9CA3AF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      <path d="m6 9 6 6 6-6" />
                    </svg>
                  </div>
                </div>
                ...
                {/* Base Salary */}
                <div className="flex items-center justify-between">
                  <label className="text-[11px] text-gray-400 font-medium">Base Salary</label>
                  <input
                    type="text"
                    value={baseSalary}
                ...
                {/* Pay Basis */}
                <div className="flex items-center justify-between">
                  <label className="text-[11px] text-gray-400 font-medium">Pay Basis</label>
                  <div className="relative">
                    <select
                      value={payBasis}
            ...
            {/* Attendance Section */}
            <div className="mb-6">
              <p className="text-[13px] font-bold text-[#0B1215] mb-4">Attendance</p>

              <div className="space-y-3">
                {/* Work Days */}
                <div className="flex items-center justify-between">
                  <label className="text-[11px] text-gray-400 font-medium">Work Days</label>
                  <input
                    type="text"
                    value={workDays}
                ...
                {/* Work Hours */}
                <div className="flex items-center justify-between">
                  <label className="text-[11px] text-gray-400 font-medium">Work Hours</label>
                  <input
                    type="text"
                    value={workHours}
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-center justify-between">
                <label className="text-[11px] text-gray-400 font-medium">Attendance Affect Pay</label>
                <Toggle
              ...
              {/* Commission Enable */}
              <div className="flex items-center justify-between">
                <label className="text-[11px] text-gray-400 font-medium">Commission Enable</label>
                <Toggle
