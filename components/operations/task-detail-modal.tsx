...
export function TaskDetailModal({
  ...
  const descriptionLines = (task.addedDescription || "")
    .split("\n")
    .filter(Boolean);
      ...
      >
        ...
        <div className="relative h-44 md:h-55 w-full bg-[#eef0f3] overflow-hidden shrink-0">
          ...
          <div className="absolute left-50 top-0 bottom-0 flex flex-col justify-center gap-1 pointer-events-none">
            <span className="text-[11px] font-semibold text-gray-400 -rotate-90 origin-center whitespace-nowrap">
              Dresd
            </span>
            <span className="text-[11px] font-semibold text-gray-400 -rotate-90 origin-center whitespace-nowrap">
              Stree
            ...
            <div className="space-y-6 md:space-y-7">
              <section>
                ...
                <p className="text-[14px] text-gray-500 leading-snug">
                  {task.description ||
                    "Cover the entirety of Ikeja, For our product publicity"}
                </p>
              </section>
              ...
              <section className="mb-6">
                ...
                <div className="text-[13px] text-gray-500 leading-relaxed space-y-1">
                  {descriptionLines.length > 0 ? (
                    ...
                    <>
                      <p>
                        Visit the Ikeja Computer village, and promote (product
                        name) to the target audience there.
                      </p>
                      <p className="mt-2">
                ...
                <div className="space-y-4 mt-1">
                  <section>
                    ...
                    <div className="relative">
                      ...
                      />
                      <span className="absolute bottom-4 right-5 text-[10px] text-gray-300 font-medium">
                        Optional
                      </span>
                    </div>
                  </section>
