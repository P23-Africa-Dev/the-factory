  ...
  return (
    <div className="flex flex-col gap-5 w-full xl:w-90 xl:shrink-0">
            ...
            <div className="mt-2 text-center">
              ...
              <div className="flex items-center justify-center gap-1.5 mt-0.5">
                ...
                <span className={`px-2 py-0.5 rounded-full text-[9px] font-bold ${
                  agent.active ? 'bg-[#9D4EDD] text-white' : 'bg-gray-200 text-gray-500'
                }`}>
      ...
      <div className="bg-dash-dark rounded-4xl p-6 shadow-2xl">
        ...
        {/* CTA */}
        <div className="mt-4">
          <button className={`px-5 py-2.5 rounded-full text-[12px] font-bold hover:opacity-90 transition-all inline-flex items-center gap-2 ${
            agent.active ? 'bg-[#9D4EDD] text-white' : 'bg-gray-600 text-white'
          }`}>
