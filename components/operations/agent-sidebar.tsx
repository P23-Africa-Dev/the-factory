...
import { Smile, Map, Plus, MapPin } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-5 w-full xl:w-90 xl:shrink-0">
      ...
      <div className="px-4 sm:px-8">
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1 space-y-3 min-w-0">
            <div>
              <h3 className="text-[13px] font-extrabold text-[#09232D] leading-tight">{agent.name}</h3>
              <p className="text-[11px] text-gray-400 mt-1 leading-relaxed max-w-[180px]">
                {agent.description || 'Visit the Ikeja Computer village, and promote...'}
              </p>
            </div>
            <div>
              <p className="text-[13px] font-bold text-[#09232D] mb-0.5">Zone</p>
              <p className="text-[12px] text-gray-400">{agent.zone}</p>
            </div>
            <div>
              <p className="text-[13px] font-bold text-[#09232D] mb-0.5">Phone Number</p>
              <p className="text-[12px] text-gray-400">{agent.phone}</p>
            </div>
            <div>
              <p className="text-[13px] font-bold text-[#09232D] mb-0.5">Role</p>
          ...
          <div className="shrink-0 flex flex-col items-center">
            <div className='bg-white p-2 rounded-[30px]'>
              {/* Avatar */}
              <div
                className="w-32 h-32 rounded-[22px] overflow-hidden shadow-md"
              // style={{ background: 'linear-gradient(145deg, #E8C547, #C9A84C)' }}
              >
                <img
                  src={agent.avatar}
              ...
              <div className="mt-2.5 flex flex-col items-center gap-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`px-2.5 py-0.75 rounded-full text-[9px] font-bold ${agent.active ? 'bg-[#22C55E] text-white' : 'bg-gray-200 text-gray-500'
                      }`}
                  >
      ...
      <div className="bg-[#0A1A22] rounded-[28px] p-6 shadow-2xl">
        ...
        <div className="relative h-48 w-full rounded-[20px] bg-[#EDF0F3] overflow-hidden shadow-inner">
          ...
          <div className="absolute flex flex-col items-center" style={{ left: 'calc(26%)', top: '48%' }}>
            ...
            <div className="bg-white px-2.5 py-1 rounded-lg mt-1.5 whitespace-nowrap shadow-lg border border-gray-100/50">
              <p className="text-[9px] font-bold text-[#09232D]">{agent.name}</p>
        ...
        <div className="mt-6">
          <button
            className={`px-6 py-2.5 rounded-full text-[12px] font-bold transition-all inline-flex items-center gap-2 cursor-pointer ${agent.active
