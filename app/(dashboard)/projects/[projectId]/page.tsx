              ...
              <div className="flex-1">
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div>
                    ...
                    <p className="text-[10px] max-w-70.75 text-[#717171] mt-1 font-light">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <button className="flex items-center gap-2 px-4 md:px-2.5 py-2.5 md:py-1.75 rounded-[10px] transition-all cursor-pointer bg-[#F8F8F8] border border-[#D1D1D1] hover:bg-gray-50 flex-1 sm:flex-initial justify-center">
                      <SlidersHorizontal
                        size={16}
                        strokeWidth={2}
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-4 md:px-2.5 py-2.5 md:py-1.75 bg-dash-dark text-white rounded-[10px] text-[10px] font-medium hover:opacity-90 transition-all shadow-md cursor-pointer whitespace-nowrap flex-1 sm:flex-initial justify-center"
                    >
                      <Image
                        src={TaskIcon}
                        alt="Add Task"
                        ...
                        height={16}
                      />
                      <span className="text-[10px] font-medium">Set Task</span>
                    </button>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 mt-6 md:mt-8">
                  <div className="space-y-1">
                    <h3 className="text-[14px] md:text-[16px] font-bold text-[#092635]">
                      Created By
                    </h3>
                    <p className="text-[10px] md:text-[10px] text-[#717171] font-light">
                      Ridwan Thomson (Supervisor)
                    </p>
                  </div>
                  <div className="space-y-1">
                    <h3 className="text-[14px] md:text-[16px] font-bold text-[#092635]">
                    ...
                    <p className="text-[14px] md:text-[10px] text-[#717171] font-light">
                      Tomorrow (Friday, 3rd April. 2026)
                    </p>
                  </div>
                  <div className="space-y-1">
                    <h3 className="text-[14px] md:text-[16px] font-bold text-[#092635]">
                    ...
                    <div className="mt-1">
                      <span className="px-4 py-0.5 bg-[#C241B4] text-white rounded-full text-[9px] font-medium inline-flex items-center justify-center">
                        Medium
                      </span>
                    </div>
                  </div>
