    ...
    <div class="mb-4 d-flex flex-wrap justify-content-between gap-2 align-items-start">
        <div>
            ...
            <p class="mb-0" style="font-size:.82rem;color:var(--text-secondary)">
                Geoapify → Foursquare → Google waterfall. Cache hits are free; Google is final fallback only.
            </p>
        </div>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.places.settings.update') }}">
                        ...
                        <div class="form-check form-switch mb-2">
                            ...
                            <label class="form-check-label" for="geoapify_enabled">Geoapify primary @unless($settings['keys_configured']['geoapify']) <span class="badge text-bg-warning">no key</span> @endunless</label>
                        </div>
                        <div class="form-check form-switch mb-2">
                            ...
                            <label class="form-check-label" for="foursquare_enabled">Foursquare secondary @unless($settings['keys_configured']['foursquare']) <span class="badge text-bg-warning">no key</span> @endunless</label>
                        </div>
                        <div class="form-check form-switch mb-2">
                            <input class="form-check-input" type="checkbox" name="google_enabled" value="1" id="google_enabled" @checked($settings['google_enabled'])>
                            <label class="form-check-label" for="google_enabled">Google final fallback @unless($settings['keys_configured']['google']) <span class="badge text-bg-warning">no key</span> @endunless</label>
                        </div>
                        ...
                        <input type="number" step="0.01" min="0.1" max="1" name="quality_threshold" class="form-control form-control-sm mb-3" value="{{ $settings['quality_threshold'] }}">
