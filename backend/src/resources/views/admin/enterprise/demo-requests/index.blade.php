        ...
        <form method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-md-3">
                ...
                <select name="status" class="form-select">
                    ...
                    <option value="provisioned" @selected(($filters['status'] ?? '') === 'provisioned')>Provisioned</option>
    ...
    <div class="metric-card">
        <div class="table-card-header">
            ...
            <div class="d-flex align-items-center gap-2">
                <a href="{{ route('admin.enterprise.demo-requests.create') }}" class="btn btn-sm btn-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.enterprise.demo-requests.show', $requestItem) }}"
                                    ...
                                    <div class="fw-semibold" style="font-size:.85rem;color:var(--text-primary)">
                                        {{ $requestItem->full_name }}</div>
                                    <div style="font-size:.75rem;color:var(--text-muted)">{{ $requestItem->email }}</div>
                                    @if ($requestItem->phone)
                                        <div style="font-size:.75rem;color:var(--text-muted)">{{ $requestItem->phone }}
                                        </div>
                                    @endif
                                </a>
                            </td>
