    ...
    <div class="row justify-content-center">
        <div class="col-lg-7">
            <div class="metric-card p-4 mb-3"
                style="border: 2px solid var(--danger, #dc2626); background: rgba(220,38,38,0.04)">
                    ...
                    <form method="POST" action="{{ route('admin.database.unlock') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="passcode" type="password" name="passcode"
                                class="form-control @error('passcode') is-invalid @enderror" autofocus required>
                            @error('passcode')
            ...
            <div class="metric-card p-4 mt-3">
                <h6 class="fw-bold mb-2" style="font-size:.9rem"><i class="bi bi-key me-2"></i>Reset Passcode With Master
                    Token</h6>
                ...
                <form method="POST" action="{{ route('admin.database.passcode.reset') }}">
                    ...
                    <div class="row g-2">
                        <div class="col-md-12">
                            ...
                            <input type="password" name="master_token"
                                class="form-control @error('master_token') is-invalid @enderror" required>
                            @error('master_token')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="password" name="new_passcode"
                                class="form-control @error('new_passcode') is-invalid @enderror" minlength="8" required>
                            @error('new_passcode')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="password" name="new_passcode_confirmation" class="form-control" minlength="8"
                                required>
                        </div>
                    </div>
