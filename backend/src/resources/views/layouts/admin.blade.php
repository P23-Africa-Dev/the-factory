    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            @if (auth('admin')->user()?->canAccessAbility('manage_billing'))
                ...
                <a href="{{ route('admin.map-credits.index') }}"
            ...
            @if (auth('admin')->user()?->canAccessAbility('manage_database'))
                <a href="{{ route('admin.database.index') }}"
                    class="nav-link {{ request()->routeIs('admin.database.*') ? 'active' : '' }}"
                    style="color: {{ request()->routeIs('admin.database.*') ? 'var(--danger, #dc2626)' : '' }}">
                    <i class="bi bi-database-lock" style="color: var(--danger, #dc2626)"></i>
                    <span class="nav-link-text">Manage Database</span>
                </a>
            @endif
