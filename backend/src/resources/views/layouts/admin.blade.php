...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sidebar-footer .admin-name { color: #fff; font-size: .8rem; font-weight: 600; }
        .sidebar-footer .admin-role { color: rgba(255,255,255,.35); font-size: .7rem; font-weight: 500; }
        ...
        .admin-table tbody tr { transition: background .1s ease; }
        .admin-table tbody tr:hover { background: var(--surface-hover); }
        .admin-table .action-col { width: 56px; text-align: center; }
        .table-card-header {
            background: var(--surface);
            border-bottom: 1px solid var(--border);
        ...
        .badge-suspended { background: rgba(245,158,11,.1); color: #d97706; }
        .badge-inactive { background: rgba(100,116,139,.1); color: #475569; }
        .badge-pending { background: rgba(245,158,11,.1); color: #d97706; }
        .badge-approved { background: rgba(59,130,246,.1); color: #2563eb; }
        .badge-activated { background: rgba(16,185,129,.1); color: #059669; }
        ...
        /* ── Buttons ─────────────────────────────────── */
        .btn { border-radius: .5rem; font-size: .82rem; font-weight: 500; }
        .btn-sm { padding: .4rem .85rem; }
        ...
        .pagination .page-link:hover { background: var(--surface-hover); }
        ...
        /* ── Modals ──────────────────────────────────── */
        .modal-content { border-radius: var(--radius-lg); border: 0; box-shadow: var(--shadow-md); }
        .modal-header { border: 0; padding: 1.25rem 1.5rem .5rem; }
        .modal-body { padding: .75rem 1.5rem; }
        .modal-footer { border: 0; padding: .5rem 1.5rem 1.25rem; }
    ...
    <div class="sidebar-footer">
        <div class="d-flex align-items-center gap-2">
            ...
            <div class="overflow-hidden">
                ...
                <div class="admin-role">{{ ucwords(str_replace('_', ' ', auth('admin')->user()?->role ?? '')) }}</div>
            </div>
        </div>
    </div>
</aside>
